...
Record `COUPLED-CHECKPOINT-A-20260916T010859Z`. Nothing in this record is coupled EM evidence: it validates a declaration, recomputes source digests, draws the declared seed geometry and estimates a mesh. No Palace solve was run. Every ENGINEERING-SEED remains unapproved.
